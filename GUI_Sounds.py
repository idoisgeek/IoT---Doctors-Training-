...
class CaseSelectorApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.setWindowTitle('Case Selector with RFID Sound Player')
    ...
    def create_main_menu(self):
        ...
        # Title
        title_label = QLabel('Case Selector with RFID Sound Player')
        title_font = QFont()
        ...
        # Subtitle
        subtitle_label = QLabel('Select a case to view details and scan RFID tags for sounds')
        subtitle_font = QFont()
        ...
        # Create case selection grid (4x3 grid for 10 cases with proper spacing)
        ...
        # View sound mappings button
        view_mappings_button = QPushButton('View Sound Mappings')
        view_mappings_button.setMinimumHeight(60)
        view_mappings_button.setMinimumWidth(200)
        button_font = QFont()
        button_font.setPointSize(12)
        view_mappings_button.setFont(button_font)
        view_mappings_button.clicked.connect(self.show_sound_mappings)
        bottom_buttons.addWidget(view_mappings_button)
        
        # Toggle fullscreen button
        toggle_button = QPushButton('Exit Fullscreen')
        toggle_button.setMinimumHeight(60)
        toggle_button.setMinimumWidth(200)
        toggle_button.setFont(button_font)
